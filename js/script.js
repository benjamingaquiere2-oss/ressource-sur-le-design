...
const RESOURCES = {
  typographie: [
    ...
    { nom: "MontiFonti", domaine: "montifonti.tilda.ws", description: "Polices gratuites pour usage commercial, avec kit de webfonts.", lien: "https://montifonti.tilda.ws/" },
    ...
    { nom: "En Travaux", domaine: "entravaux.framer.website", description: "Ils proposent des polices de caractères gratuites (ou accessibles) et des créations typographiques expérimentales, conçues par et pour un large éventail de créatifs du design. La plupart des polices sont gratuites et soumises à une Licence de Police Libre.", lien: "https://entravaux.framer.website/" }
